...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login.setOnClickListener(view -> AllowUserToLogin());
        register.setOnClickListener(view -> sendUserToRegister());
        //if user forgets the password then to reset it
        forgotPassword.setOnClickListener(view -> resetPasswordUser());
    }
